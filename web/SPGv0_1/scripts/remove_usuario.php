...
if(isset($_SESSION['login'])){
	...
	/*---------COLSULTA USUARIOS----------*/
	$retorno = "<div class='col-md-12'><h3><center>Remoção de Membros</center></h3><br></div>";
	$contador = 1;
	$sql = 	"SELECT * FROM usuario JOIN perfil WHERE usuario.perfil_id = id ORDER BY nome ASC";
